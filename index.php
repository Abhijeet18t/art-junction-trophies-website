...
$ext=$row['img_ext'];
 				...
 				echo"<li>
                  <div class='testimonial clearfix'>
                    <div class='mar-bot20'>
                      <img alt='' src='img/testimonial/".$name.".".$ext."?' class='img-circle'>
                    </div>
      ...
      <div class="row">
        <nav id="filter" class="col-md-12 text-center">
          <ul>
            ...
            <li><a href="#" class="btn btn-small" data-filter=".TROPHIES">TROPHIES</a></li>
            <li><a href="#" class="btn btn-small" data-filter=".MEDALS">MEDALS</a></li>
            <li><a href="#" class="btn btn-small" data-filter=".T-SHIRTS">T-SHIRTS</a></li>
          </ul>
        </nav>
        <div class="col-md-12">
          <div class="row">
...
<?php
include_once "includes/db2.inc.php";	
$sql1="SELECT * FROM gal;";
$result=mysqli_query($conn,$sql1);
while($row=mysqli_fetch_assoc($result))
{
$name=$row['img_name'];
...
$cat=$row['img_cat'];
              ...
              echo"<article class='col-md-4 isotopeItem ".$cat."'>
                <div class='portfolio-item'>
                  <img src='img/portfolio/".$name.".".$ext."?' alt=''>
                  <div class='portfolio-desc align-center'>
                    <div class='folio-info'>
                      <h5><a href='#'>Portfolio name</a></h5>
                      <a href='img/portfolio/".$name.".".$ext."?' class='fancybox'><i class='fa fa-plus fa-2x'></i></a>
                    </div>
                  </div>
                </div>
			 </article>";
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
		  ...
		  <?php
		  include_once"includes/db1.inc.php";
...
$ext=$row['img_ext'];
            ...
            echo"<div class='col-sm-2 align-center'>
             <img alt='logo' src='img/clients/".$name.".".$ext."?'></div>";
} ?>
  ...
  <section id="section-map" class="clearfix">
    <iframe src="https://www.google.com/maps/embed?pb=!1m26!1m12!1m3!1d241996.72242425542!2d73.60627029119344!3d18.610126512675304!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m11!3e6!4m3!3m2!1d18.6201901!2d73.7471888!4m5!1s0x3bc2c77ebbeea093%3A0xeb43ffe079833200!2sArt%20Junction%2C%20Gavhanevasti%2C%20Bhosari%2C%20Pimpri-Chinchwad%2C%20Maharashtra%20411039!3m2!1d18.6164027!2d73.8467488!5e0!3m2!1sen!2sin!4v1572934805640!5m2!1sen!2sin" width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe>
  </section>
