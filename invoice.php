	...
	<header class="clearfix">
		<div class="container">
			...
			<div class="company-address">
				<h2 class="title">ART JUNCTION</h2>
				<p>
					art junction,bhosari,<br>
					INDIA.
		...
		<div class="container">
			<div class="details clearfix">
				<div class="client left">
					<p>INVOICE TO:</p>
					<p class="name" contenteditable>John Doe</p>
					<p contenteditable>796 Silver Harbour, TX 79273, US</p>
					
				</div>
				<div class="data right">
					<div class="title" contenteditable>QUOTATION 1</div>
					<div class="date" contenteditable>
					<?php
					$now = date("d/m/Y");
					
						echo"Date of Invoice: $now";?><br>
					...
					<tbody>
						...
						<tr>
						 ...
						 ?>
							...
							<td class="qty"></td>
							<?php
							echo"<td class='unit'>GST $gs%:</td>";
					
							
							$gst=($sum*$gs)/100;
							$gt=$gst+$sum;
							echo"<td class='total'>$gst</td>";?>
						</tr>
						<tr>
							<td class="desc"></td>
							<td class="unit" colspan="2">GRAND TOTAL:</td>
							<?php
							echo"<td class='total'>$gt</td>"
							?>
						</tr>
					</tbody>
				</table>
